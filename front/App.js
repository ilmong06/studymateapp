...
import CreateChatScreen from "./src/screens/community/chat/CreateChatScreen"
...
import GroupScheduleManagementScreen from './src/screens/groupStudy/GroupScheduleManagementScreen';
import GroupPerformanceAndRewardsScreen from './src/screens/groupStudy/GroupPerformanceAndRewardsScreen';
import StudyMaterialManagementScreen from './src/screens/groupStudy/StudyMaterialManagementScreen';
import GroupMemberListScreen from './src/screens/groupStudy/GroupMemberListScreen';
import LearningMaterialsManagementScreen from './src/screens/groupStudy/LearningMaterialsManagementScreen';
import LearningResourceCenterScreen from './src/screens/groupStudy/LearningResourceCenterScreen';
import MemberRoleManagementScreen from './src/screens/groupStudy/MemberRoleManagementScreen';
import MemberViewScreen from './src/screens/groupStudy/MemberViewScreen';
import PerformanceAnalysisScreen from './src/screens/groupStudy/PerformanceAnalysisScreen';
...
const ChatNavigator = () => (
    <ChatStack.Navigator id="ChatStack" screenOptions={{ headerShown: false }}>
        ...
        <ChatStack.Screen name="EditRoomName" component={EditRoomNameScreen} />
...
const GroupStudyNavigator = () => (
    <GroupStudyStack.Navigator id="GroupStudyStack" screenOptions={{ headerShown: false }}>
        ...
        <GroupStudyStack.Screen name="GroupScheduleManagement" component={GroupScheduleManagementScreen} />
        <GroupStudyStack.Screen name="GroupPerformanceAndRewards" component={GroupPerformanceAndRewardsScreen} />
        <GroupStudyStack.Screen name="StudyMaterialManagement" component={StudyMaterialManagementScreen} />
        <GroupStudyStack.Screen name="GroupMemberList" component={GroupMemberListScreen} />
        <GroupStudyStack.Screen name="LearningMaterialsManagement" component={LearningMaterialsManagementScreen} />
        <GroupStudyStack.Screen name="LearningResourceCenter" component={LearningResourceCenterScreen} />
        <GroupStudyStack.Screen name="MemberRoleManagement" component={MemberRoleManagementScreen} />
        <GroupStudyStack.Screen name="MemberView" component={MemberViewScreen} />
        <GroupStudyStack.Screen name="PerformanceAnalysis" component={PerformanceAnalysisScreen} />
