...
const BASE_URL = 'http://172.30.89.34:3000';
...
export const chatAPI = {
    ...
    markAsRead: async (roomId, messageId) => {
        const response = await api.put(`/api/chat/rooms/${roomId}/messages/${messageId}/read`);
        return response.data;
    },
    ...
    searchRooms: async (query) => {
        const response = await api.get(`/api/chat/rooms/search?query=${query}`);
        return response.data;
    },
    ...
    pinChatRoom: async (roomId, isPinned) => {
        const response = await api.put(`/api/chat/rooms/${roomId}/pin`, { isPinned });
        return response.data;
    },
    ...
    sendImageMessage: async (roomId, formData) => {
        const response = await api.post(`/api/chat/rooms/${roomId}/messages/image`, formData, {
            headers: {
    ...
    updateRoomSettings: async (roomId, data) => {
        const response = await api.put(`/api/chat/rooms/${roomId}/settings`, data);
        return response.data;
    },
    ...
    updateRoomName: async (roomId, data) => {
        const response = await api.put(`/api/chat/rooms/${roomId}/name`, data);
        return response.data;
    },
    ...
    updateParticipants: async (roomId, data) => {
        const response = await api.put(`/api/chat/rooms/${roomId}/participants`, data);
        return response.data;
    },
    ...
    toggleImportant: async (messageId) => {
        const response = await api.put(`/api/chat/messages/${messageId}/important`);
        return response.data;
    },
...
export const backupAPI = {
    ...
    updateSettings: async (data) => {
        const response = await api.put('/api/backup/settings', data);
        return response.data;
    },
};
...
export const friendsAPI = {
    ...
    startChat: async (friendId) => {
        const response = await api.post(`/api/chat/start`, { friendId });
        return response.data;
    },
};
...
export const profileAPI = {
    ...
    updateStatus: async (message) => {
        const response = await api.put('/api/profile/status', { message });
        return response.data;
    }
};
...
export const communityAPI = {
    ...
    validateQuestion: async (data) => {
        const response = await api.post('/api/community/questions/validate', data);
        return response.data;
    },
    ...
    createQuestion: async (data) => {
        const response = await api.post('/api/community/questions', data);
        return response.data;
    },
    ...
    getQuestions: async (params) => {
        const response = await api.get('/api/community/questions', { params });
        return response.data;
    },
    ...
    updateQuestion: async (questionId, data) => {
        const response = await api.put(`/api/community/questions/${questionId}`, data);
        return response.data;
    },
    ...
    createAnswer: async (questionId, data) => {
        const response = await api.post(`/api/community/questions/${questionId}/answers`, data);
        return response.data;
    },
    ...
    updateAnswer: async (answerId, data) => {
        const response = await api.put(`/api/community/answers/${answerId}`, data);
        return response.data;
    },
    ...
    getData: async (tab) => {
        const response = await api.get(`/api/community/${tab}`);
        return response.data;
    },
};
...
export const groupAPI = {
    ...
    getRecentGroups: async () => {
        const response = await api.get('/api/groups/recent');
        return response.data;
    },
    ...
    getGroupMembers: async (groupId, params) => {
        const response = await api.get(`/api/groups/${groupId}/members`, { params });
        return response.data;
    },
    ...
    handleJoinRequest: async (groupId, requestId, action) => {
        const response = await api.post(`/api/groups/${groupId}/join-requests/${requestId}/${action}`);
        return response.data;
    },
    ...
    handleBulkMemberRequests: async (groupId, data) => {
        const response = await api.post(`/api/groups/${groupId}/requests/bulk`, data);
        return response.data;
    },
    ...
    getMemberRequestDetail: async (groupId, requestId) => {
        const response = await api.get(`/api/groups/${groupId}/requests/${requestId}`);
        return response.data;
    },
    ...
    inviteMembers: async (groupId, userIds) => {
        const response = await api.post(`/api/groups/${groupId}/invite`, { userIds });
        return response.data;
    },
    ...
    createInvitation: async (groupId) => {
        const response = await api.post(`/api/groups/${groupId}/invite-code`);
        return response.data;
    },
    ...
    updateGroupSettings: async (groupId, data) => {
        const response = await api.put(`/api/groups/${groupId}/settings`, data);
        return response.data;
    },
    ...
    searchMembers: async (groupId, query) => {
        const response = await api.get(`/api/groups/${groupId}/members/search`, { params: { query } });
        return response.data;
    },
    ...
    handleFeedAction: async (groupId, feedId, actionType) => {
        const response = await api.post(`/api/groups/${groupId}/feeds/${feedId}/${actionType}`);
        return response.data;
    }
};
...
export const fileAPI = {
    ...
    filterFilesByType: async (type) => {
        const response = await api.get(`/api/files/filter/${type}`);
        return response.data;
    },
    ...
    updateFileSharing: async (fileId, isShared) => {
        const response = await api.put(`/api/files/${fileId}/share`, { isShared });
        return response.data;
    },
    ...
    setFileExpiry: async (fileId, expiryDate) => {
        const response = await api.put(`/api/files/${fileId}/expiry`, { expiryDate });
        return response.data;
    },
...
export const inviteAPI = {
    ...
    // @returns: {users: User[]}
    searchUsers: async (query) => {
        const response = await api.get('/api/invite/search', { params: { query } });
        return response.data;
    },
    ...
    sendInvitations: async (userIds) => {
        const response = await api.post('/api/invite/send', { userIds });
        return response.data;
    },
    ...
    acceptInvitation: async (inviteId) => {
        const response = await api.post(`/api/invite/${inviteId}/accept`);
        return response.data;
    },
    ...
    rejectInvitation: async (inviteId) => {
        const response = await api.post(`/api/invite/${inviteId}/reject`);
        return response.data;
    }
};
...
export const mentorAPI = {
    ...
    validateMentorInfo: async (data) => {
        const response = await api.post('/api/mentors/validate', data);
        return response.data;
    },
    ...
    updateMentorInfo: async (mentorId, data) => {
        const response = await api.put(`/api/mentors/${mentorId}`, data);
        return response.data;
    },
    ...
    getMentorDetail: async (mentorId) => {
        const response = await api.get(`/api/community/mentors/${mentorId}`);
        return response.data;
    },
...
export const achievementAPI = {
    ...
    updateProgress: async (achievementId, progress) => {
        const response = await api.put(`/api/achievements/${achievementId}/progress`, { progress });
        return response.data;
    },
...
export const studyAPI = {
    ...
    endStudySession: async (sessionId) => {
        const response = await api.post(`/api/study/sessions/${sessionId}/end`);
        return response.data;
    },
    ...
    getStatistics: async (params) => {
        const response = await api.get('/api/study/statistics', { params });
        return response.data;
    },
    ...
    getRecommendations: async () => {
        const response = await api.get('/api/study/recommendations');
        return response.data;
    },
    ...
    getAnalytics: async (timeRange) => {
        const response = await api.get(`/api/study/analytics/${timeRange}`);
        return response.data;
    },
    ...
    getSubjectAnalytics: async (subjectId, timeRange) => {
        const response = await api.get(`/api/study/subjects/${subjectId}/analytics`, {
            params: { timeRange }
        });
        return response.data;
    },
    ...
    getSchedules: async (date) => {
        const response = await api.get('/api/study/schedules', {
            params: { date }
        });
        return response.data;
    },
    ...
    createSchedule: async (data) => {
        const response = await api.post('/api/study/schedules', data);
        return response.data;
    },
    ...
    updateSchedule: async (scheduleId, data) => {
        const response = await api.put(`/api/study/schedules/${scheduleId}`, data);
        return response.data;
    },
    ...
    deleteSchedule: async (scheduleId) => {
        const response = await api.delete(`/api/study/schedules/${scheduleId}`);
        return response.data;
    },
    ...
    saveJournal: async (data) => {
        const response = await api.post('/api/study/feedback/journal', data);
        return response.data;
    },
    ...
    getFeedback: async () => {
        const response = await api.get('/api/study/feedback');
        return response.data;
    },
    ...
    saveSelfEvaluation: async (data) => {
        const response = await api.post('/api/study/feedback/self-evaluation', data);
        return response.data;
    },
    ...
    shareMaterial: async (materialId) => {
        const response = await api.post(`/api/materials/${materialId}/share`);
        return response.data;
    },
    ...
    updateVersion: async (materialId) => {
        const response = await api.put(`/api/materials/${materialId}/version`);
        return response.data;
    },
    ...
    endSession: async (data) => {
        const response = await api.post('/api/study/sessions/end', data);
        return response.data;
    },
    ...
    updateCycles: async (data) => {
        const response = await api.put('/api/study/sessions/cycles', data);
        return response.data;
    },
    ...
    saveNotes: async (data) => {
        const response = await api.post('/api/study/sessions/notes', data);
        return response.data;
    },
};
...
export const levelAPI = {
    ...
    getLevelInfo: async () => {
        const response = await api.get('/api/levels/info');
        return response.data;
    },
    ...
    getLevelStats: async () => {
        const response = await api.get('/api/levels/stats');
        return response.data;
    },
    ...
    getLevelRequirements: async () => {
        const response = await api.get('/api/levels/requirements');
        return response.data;
    },
    ...
    gainExperience: async (data) => {
        const response = await api.post('/api/levels/experience', data);
        return response.data;
    }
};
...
export const userAPI = {
    ...
    validateName: async (name) => {
        const response = await api.post('/api/users/validate-name', { name });
        return response.data;
    },
    ...
    updateName: async (name) => {
        const response = await api.put('/api/users/name', { name });
        return response.data;
    },
    ...
    uploadImage: async (type, formData) => {
        const response = await api.post(`/api/users/profile/${type}-image`, formData, {
            headers: {
                'Content-Type': 'multipart/form-data',
            }
        });
    ...
    validatePhone: async (phone) => {
        const response = await api.post('/api/users/validate-phone', { phone });
        return response.data;
    },
    ...
    validatePassword: async (password) => {
        const response = await api.post('/api/users/validate-password', { password });
        return response.data;
    },
    ...
    updatePrivacy: async (data) => {
        const response = await api.put('/api/users/profile/privacy', data);
        return response.data;
    },
    ...
    disconnectAccount: async (accountId) => {
        const response = await api.delete(`/api/users/accounts/${accountId}`);
        return response.data;
    },
    ...
    getPrimaryAccount: async () => {
        const response = await api.get('/api/users/primary-account');
        return response.data;
    },
    ...
    setPrimaryAccount: async (accountId) => {
        const response = await api.put(`/api/users/primary-account/${accountId}`);
        return response.data;
    },
    ...
    disconnectSocialAccount: async (accountId) => {
        const response = await api.delete(`/api/users/social-accounts/${accountId}`);
        return response.data;
    },
};
...
export const settingsAPI = {
    ...
    updateDisplayMode: async (data) => {
        const response = await api.put('/api/settings/display/mode', data);
        return response.data;
    },
    ...
    updateDisplaySettings: async (data) => {
        const response = await api.put('/api/settings/display', data);
        return response.data;
    },
    ...
    updateFontSettings: async (data) => {
        const response = await api.put('/api/settings/font', data);
        return response.data;
    },
    ...
    requestNotificationPermission: async () => {
        const response = await api.post('/api/settings/notifications/permission');
        return response.data;
    },
    ...
    // @returns: void
    openSystemSettings: () => {
        return api.post('/api/settings/system/open');
    },
    ...
    updateAutoBackup: async (data) => {
        const response = await api.put('/api/settings/backup/auto', data);
        return response.data;
    },
    ...
    updateTimeSettings: async (title, data) => {
        const response = await api.put(`/api/settings/time/${title}`, data);
        return response.data;
    },
};
...
export const goalAPI = {
    ...
    updateGoalProgress: async (goalId, data) => {
        const response = await api.put(`/api/goals/${goalId}/progress`, data);
        return response.data;
    },
    ...
    updateGoalStatus: async (goalId, status) => {
        const response = await api.put(`/api/goals/${goalId}/status`, { status });
        return response.data;
    },
    ...
    getCategories: async () => {
        const response = await api.get('/api/goals/categories');
        return response.data;
    },
    ...
    validateGoal: async (data) => {
        const response = await api.post('/api/goals/validate', data);
        return response.data;
    },
};
...
export const feedbackAPI = {
    ...
    getSelfEvaluationHistory: async () => {
        const response = await api.get('/api/feedback/self-evaluation/history');
        return response.data;
    },
    ...
    getJournalHistory: async () => {
        const response = await api.get('/api/feedback/journal/history');
        return response.data;
    },
    ...
    // @returns: {success: boolean}
    saveSelfEvaluation: async (data) => {
        const response = await api.post('/api/feedback/self-evaluation', data);
        return response.data;
    },
    ...
    // @returns: {success: boolean}
    saveJournal: async (data) => {
        const response = await api.post('/api/feedback/journal', data);
        return response.data;
    }
};
...
export const materialAPI = {
    ...
    updateMaterial: async (materialId, data) => {
        const response = await api.put(`/api/materials/${materialId}`, data);
        return response.data;
    },
    ...
    shareMaterial: async (materialId, data) => {
        const response = await api.post(`/api/materials/${materialId}/share`, data);
        return response.data;
    },
