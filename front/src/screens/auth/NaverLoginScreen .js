...
const NaverLoginScreen = ({ navigation }) => {
    ...
    const sendCodeToBackend = async (code) => {
        try {
            ...
            // API 요청
            const response = await api.post(`/auth/naver-login`, {
                params: { code },
            });
    ...
    return (
        <View style={{ flex: 1 }}>
            <WebView
                ...
                style={{ marginTop: 30 }}
                source={{
                    uri: 'https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=3IN_ttzu0_MGrY_82X6k&redirect_uri=https://auth.expo.io/@wovlf02/frontend',
                }}
